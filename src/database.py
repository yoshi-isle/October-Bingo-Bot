...
class Team:
    def __init__(self, _id, name, members, points, channel_id, mini_task, fun_task, full_task, family_task, bucket_task, submission_history, updating, spreadsheet, image):
        self._id = _id
        self.name = name
